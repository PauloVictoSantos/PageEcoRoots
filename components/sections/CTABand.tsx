  ...
  return (
    <section className="py-24">
      <div className="container mx-auto px-4">
        <motion.div
          {...fadeUp()}
          className="relative rounded-3xl overflow-hidden border border-[#58D68D]/15 
          bg-linear-to-br from-[#0B3D2E]/60 to-[#0a0a0a] p-12 md:p-16 text-center"
        >
          <img
            src="/image/27885329_spring_leaves_001v1_23.jpg"
            alt=""
            className="absolute inset-0 w-full h-full rotate-180 object-cover 
